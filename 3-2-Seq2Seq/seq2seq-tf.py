...
# Model
# [batch_size, max_len(=encoder_step), n_class]
enc_input = tf.placeholder(tf.float32, [None, None, n_class])
# [batch_size, max_len+1(=decoder_step) (becase of 'S' or 'E'), n_class]
dec_input = tf.placeholder(tf.float32, [None, None, n_class])
# [batch_size, max_len+1], not one-hot
...
with tf.Session() as sess:
    ...
    # Test
    print('test')
    print('man ->', translate(sess, 'man'))
    print('mans ->', translate(sess, 'mans'))
    print('king ->', translate(sess, 'king'))
    print('black ->', translate(sess, 'black'))
    print('upp ->', translate(sess, 'upp'))
